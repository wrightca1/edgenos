...
if [ -d "$PAY" ]; then
    ...
    for b in kexec resettool scdreg fm6000_bringup si5338 pcicfg scddump fm6000reg fm6000load fm6000_i2c_bringup fm6000_l2_probe fpdma_probe fm6000_crm fm6000_sched fm6000_wr128 fm6000_mrl; do
