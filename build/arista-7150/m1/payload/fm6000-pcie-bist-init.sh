...
echo "[pbi] BIST: wait for march complete (poll BM_STATUS 0x1D08E == 0)"
sleep 2; n=0; while [ $n -lt 15 ]; do st=$(RD 0x1D08E); st=${st:-x}; [ "$st" = "00000000" ] && break; sleep 1; n=$((n+1)); done
echo "[pbi] BIST done (${n}s, BM_STATUS=0x$st, result 0x1D70E=0x$(RD 0x1D70E))"
