...
#define FM6000_DESC_BIT3        0x08u      /* status bit3 -- UNIDENTIFIED. Set on the
                                            * short malformed ring entries, CLEAR on
                                            * good frames -- the opposite of what EOP
                                            * would do. Probably an error bit. */
