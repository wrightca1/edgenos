 ...
 * both working ports. */
static const struct op INIT[] = {
	{ OP_MMIO, 0x10, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x00800000u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00005381u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x20000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00005381u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x20000300u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x400003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00000600u, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x12, 0x00000600u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x60000300u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x400003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00000600u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x60000300u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x408003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00000600u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x00000300u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x408003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00000600u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x20000300u, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x20000320u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x408003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x25, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x37, 0x000c0002u, 0x00, 0x00 },
	{ OP_MMIO, 0x3c, 0x000001eeu, 0x00, 0x00 },
	{ OP_MMIO, 0x37, 0x018c0002u, 0x00, 0x00 },
	{ OP_MMIO, 0x39, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x3a, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x3b, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x37, 0x000c0002u, 0x00, 0x00 },
	{ OP_MMIO, 0x40, 0x00003fdfu, 0x00, 0x00 },
	{ OP_MMIO, 0x34, 0x0aaa86c0u, 0x00, 0x00 },
	{ OP_MMIO, 0x35, 0x00000001u, 0x00, 0x00 },
	{ OP_MMIO, 0x39, 0x00280280u, 0x00, 0x00 },
	{ OP_MMIO, 0x3a, 0x80000080u, 0x00, 0x00 },
	{ OP_MMIO, 0x3b, 0x00000803u, 0x00, 0x00 },
	{ OP_MMIO, 0x40, 0x00003fdfu, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x20000320u, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x400003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x37, 0x000c0002u, 0x00, 0x00 },
	{ OP_MMIO, 0x40, 0x00003fdfu, 0x00, 0x00 },
	{ OP_MMIO, 0x04, 0x00000001u, 0x00, 0x00 },
	{ OP_MMIO, 0x02, 0x07fffffeu, 0x00, 0x00 },
	{ OP_MMIO, 0x01, 0x00000a80u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x20000320u, 0x00, 0x00 },
	{ OP_MMIO, 0x37, 0x018c0002u, 0x00, 0x00 },
	{ OP_MMIO, 0x39, 0x00280280u, 0x00, 0x00 },
	{ OP_MMIO, 0x3a, 0x80000080u, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x40, 0x00003fdfu, 0x00, 0x00 },
	{ OP_MMIO, 0x39, 0x00280280u, 0x00, 0x00 },
	{ OP_MMIO, 0x3a, 0xc0000080u, 0x00, 0x00 },
	{ OP_MMIO, 0x3b, 0x00000803u, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x6000033cu, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x400003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x6000033cu, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x0000033cu, 0x00, 0x00 },
	{ OP_MMIO, 0x11, 0x408003e0u, 0x00, 0x00 },
	{ OP_MMIO, 0x12, 0x00002414u, 0x00, 0x00 },
	{ OP_MMIO, 0x13, 0x00001841u, 0x00, 0x00 },
	{ OP_MMIO, 0x10, 0x2000033cu, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x10, 0x2000033cu, 0x00, 0x00 },
	{ OP_MMIO, 0x02, 0x07fffffeu, 0x00, 0x00 },
	{ OP_MMIO, 0x18, 0x00000000u, 0x00, 0x00 },
	{ OP_MMIO, 0x19, 0x00000000u, 0x00, 0x00 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x1f, 0x49 },
	...
	{ OP_SBUS, 0x22, 0x00000000u, 0x00, 0xfd },
	{ OP_SBUS, 0x22, 0x00000000u, 0x02, 0xfd },
	{ OP_SBUS, 0x21, 0x00000016u, 0x2a, 0x49 },
	{ OP_SBUS, 0x21, 0x00000000u, 0x01, 0xfd },
	{ OP_SBUS, 0x21, 0x00000020u, 0x02, 0xfd },
	{ OP_SBUS, 0x21, 0x00000049u, 0x03, 0xfd },
	{ OP_SBUS, 0x21, 0x00000018u, 0x0c, 0xfd },
...
#define NINIT ((int)(sizeof INIT / sizeof INIT[0]))
