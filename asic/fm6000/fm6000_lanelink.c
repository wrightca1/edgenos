 ...
 *
 * This tool keeps only the genuinely port-specific part -- 52 EPL-lane MMIO ops
 * and 37 SBus ops -- expressed RELATIVE to the lane, and derives everything
 * port-dependent:
 *
...
static const struct op SEQ[] = {
	...
	{ OP_MMIO, 0x3a, 0xc0000580u, 0x00, 0x00 },
	...
	{ OP_MMIO, 0x3a, 0xc0000580u, 0x00, 0x00 },
	{ OP_MMIO, 0x3b, 0x00000883u, 0x00, 0x00 },
	{ OP_SBUS, 0x21, 0x0000001fu, 0x01, 0x49 },
	{ OP_SBUS, 0x21, 0x0000003fu, 0x02, 0x49 },
	...
	{ OP_MMIO, 0x3a, 0xc0000581u, 0x00, 0x00 },
	{ OP_MMIO, 0x3b, 0x00000883u, 0x00, 0x00 },
	{ OP_MMIO, 0x40, 0x00003f1fu, 0x00, 0x00 },
	...
	{ OP_SBUS, 0x20, 0x00000000u, 0x00, 0x49 },
	{ OP_SBUS, 0x21, 0x00000010u, 0x17, 0x49 },
	{ OP_SBUS, 0x21, 0x00000000u, 0x06, 0x49 },
	{ OP_MMIO, 0x3a, 0xc0000581u, 0x00, 0x00 },
	{ OP_MMIO, 0x3b, 0x00000c83u, 0x00, 0x00 },
	{ OP_MMIO, 0x37, 0x000c0002u, 0x00, 0x00 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x1f, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x24, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x20, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x21, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x22, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x23, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x24, 0x49 },
	{ OP_MMIO, 0x37, 0x008c0002u, 0x00, 0x00 },
	{ OP_MMIO, 0x3c, 0x000001e2u, 0x00, 0x00 },
	{ OP_MMIO, 0x39, 0x002a0281u, 0x00, 0x00 },
	{ OP_SBUS, 0x21, 0x00000000u, 0x17, 0x49 },
	{ OP_SBUS, 0x21, 0x0000000eu, 0x2a, 0x49 },
	{ OP_SBUS, 0x21, 0x00000002u, 0x2b, 0x49 },
	{ OP_MMIO, 0x02, 0x07ffffffu, 0x00, 0x00 },
	{ OP_MMIO, 0x04, 0x07ffffffu, 0x00, 0x00 },
	{ OP_MMIO, 0x02, 0x07fffffeu, 0x00, 0x00 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x1f, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x24, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x25, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x26, 0x49 },
	{ OP_SBUS, 0x22, 0x00000000u, 0x27, 0x49 },
	{ OP_SBUS, 0x21, 0x00000000u, 0x01, 0xfd },
	{ OP_SBUS, 0x21, 0x00000020u, 0x02, 0xfd },
	{ OP_SBUS, 0x21, 0x00000049u, 0x03, 0xfd },
...
int main(int argc, char **argv)
{
	...
	for (i = 0; i < NSEQ; i++) {
		...
		if (o->kind == OP_MMIO) {
			...
			uint32_t d = o->dev == 0x49u ? (uint32_t)dev : o->dev;
			uint32_t data = o->val;
			if (o->dev == 0xfdu && o->reg == 0x03u && data == 0x49u)
				data = (uint32_t)dev;
