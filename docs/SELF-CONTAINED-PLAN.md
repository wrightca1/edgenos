...
| block | EOS writes | our tool | emits | placement | status |
|---|---:|---|---:|---|---|
...
| L2L | 24,620 | `fm6000_l2linit` | 24,568 | by address list, table only | ✅ |
| FFU | 14,549 | `fm6000_ffuinit` | 8,680 | by address list, table only | ✅ |
| EPL | 22,051 | `fm6000_eplinit` | 1,027 | — | ❌ wedges the chip |
